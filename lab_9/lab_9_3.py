...
from val_output import print_matrix, print_info,print_ans
...
def main():
    ...
    print_ans(f"Количество элементов столбцов матрицы A, больших среднего соответствующих столбцов матрицы B:",counts)
